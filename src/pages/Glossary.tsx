...
const Glossary: React.FC = () => {
  ...
  const seo = {
    title: 'Solar Glossary | UK Solar Jargon Explained',
    description: 'Confused by solar jargon? Our comprehensive UK solar glossary explains hundreds of terms, from AC/DC and Inverters to MPPT and Tariffs.',
    path: '/glossary',
    keywords: 'solar glossary, solar dictionary, solar jargon, solar terms, UK solar definitions',
  };
  ...
  usePageMetadata({
    ...
    schema: [
      createCollectionPageSchema({
        ...
        description: seo.description,
        path: seo.path,
        about: 'Solar energy terminology and definitions',
      }),
      createBreadcrumbSchema([
        { name: 'Home', path: '/' },
        { name: 'Education', path: '/education' },
        { name: 'Solar Glossary', path: seo.path },
      ]),
    ],
  });

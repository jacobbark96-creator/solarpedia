...
import { createBreadcrumbSchema, createCollectionPageSchema } from '../lib/seo';
...
const Tools: React.FC = () => {
  const seo = {
    title: 'Solar Calculators & Interactive Tools UK',
    description: 'Free interactive solar calculators. Estimate solar savings, compare export tariffs, and calculate battery ROI for your UK home.',
    path: '/tools',
    keywords: 'solar calculator, battery ROI calculator, solar export tariff calculator, EV solar calculator, UK solar tools',
  };
  ...
  usePageMetadata({
    ...
    schema: [
      createCollectionPageSchema({
        ...
        description: seo.description,
        path: seo.path,
        about: 'Interactive solar calculators and tools',
      }),
      createBreadcrumbSchema([
        { name: 'Home', path: '/' },
        { name: 'Tools & Calculators', path: seo.path },
      ]),
    ],
  });
